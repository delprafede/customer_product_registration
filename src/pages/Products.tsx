  ...
  return (
    <>
      ...
      <div className="flex justify-between">
        {products.length === 0 ? <h2 className="text-4xl font-extrabold text-slate-500">No hay productos</h2> : <h2 className="text-4xl font-extrabold text-slate-500">Productos</h2>}
        <Link
          to="/products/new"
